# MariaDB service for Wodby

Use MariaDB as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public MariaDB service in the Wodby catalog.

- [MariaDB service in the Wodby catalog](https://wodby.com/services/mariadb)
...
4. Reference `mariadb` from your stack manifest.
